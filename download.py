...
CACHE_ROOT_PATH = "trained_models"
...
p = pose_net_pretrained_model_path(dataset='ycb')
print("Downloading refinenet...")
p = pose_refine_net_pretrained_model_path(dataset='ycb')
print("Downloading posenet...")
p = pose_net_pretrained_model_path(dataset='linemod')
print("Downloading refinenet...")
p = pose_refine_net_pretrained_model_path(dataset='linemod')